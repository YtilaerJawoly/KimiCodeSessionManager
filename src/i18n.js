...
const locales = {
  'zh-CN': {
    ...
    'createProjectMenu.confirm': '确认创建？',
    'createProjectMenu.confirmed': '创建',
    'createProjectMenu.cancelled': '取消',
    'createProjectMenu.invalidName': '项目名称包含非法字符：{chars}',
    'createProjectMenu.emptyName': '项目名称不能为空',
    'createProjectMenu.reservedName': '项目名称不能为 . 或 ..',
    'createProjectMenu.exists': '项目 {name} 已存在',
    'createProjectMenu.success': '已创建项目：{path}',
    'createProjectMenu.failed': '创建项目失败：{message}',
    'createProjectMenu.openExplorerFailed': '打开资源管理器失败：{message}',
    ...
    'worktreeMenu.title': '{name} — 选择 worktree：',
    'worktreeMenu.back': '返回上一级',
    'worktreeMenu.mainLabel': '[main]',
    'worktreeMenu.worktreeLabel': '[worktree]',
    'worktreeMenu.sessionMeta': '{count} 个会话, 最近 {time}',
    ...
    'projectMenu.launchFailed': '启动 Kimi Code 失败：{message}',
  ...
  en: {
    ...
    'mainMenu.createProject': 'Create New Project',
    'mainMenu.exit': 'Exit',
    ...
    'createProjectMenu.confirm': 'Confirm creation?',
    'createProjectMenu.confirmed': 'Create',
    'createProjectMenu.cancelled': 'Cancel',
    'createProjectMenu.invalidName': 'Project name contains invalid characters: {chars}',
    'createProjectMenu.emptyName': 'Project name cannot be empty',
    'createProjectMenu.reservedName': 'Project name cannot be . or ..',
    'createProjectMenu.exists': 'Project {name} already exists',
    'createProjectMenu.success': 'Project created: {path}',
    'createProjectMenu.failed': 'Failed to create project: {message}',
    'createProjectMenu.openExplorerFailed': 'Failed to open file explorer: {message}',
    ...
    'worktreeMenu.title': '{name} — Select worktree:',
    'worktreeMenu.back': 'Back',
    'worktreeMenu.mainLabel': '[main]',
    'worktreeMenu.worktreeLabel': '[worktree]',
    'worktreeMenu.sessionMeta': '{count} sessions, latest {time}',
    ...
    'projectMenu.launchFailed': 'Failed to launch Kimi Code: {message}',
